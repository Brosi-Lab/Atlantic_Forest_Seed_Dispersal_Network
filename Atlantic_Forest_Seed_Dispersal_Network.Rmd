...
```{r summarize degree mean per ecoregion per risk level}
...
* Mean degree for frugivores in with increasing population sizes
...
```
* Mean degree for frugivores in with decreasing population sizes
...
```{r summarise number frugivores per pop category at ecoregion level}
eco_temp %>% 
...
The decreasing populations outnumber the increasing populations. 
...
## Figures of frugivore degrees in high vs low extinction risk groups and decreasing vs increasing population groups for each ecoregion
...
# save it 
#ggsave(save, file = "degree_comparison_panel.pdf", units = "in", width = 6.75, height = 8, dpi = 400)

# save as png to put in manuscript
#ggsave(save, file = "degree_comparison_panel.png", units = "in", width = 6.75, height = 8, dpi = 400)
