...
testDispersion(sim.out.specialist_tree_mod, plot = F) # print dispersion results

testZeroInflation(sim.out.specialist_tree_mod, plot = F) # print zero-inflation results
