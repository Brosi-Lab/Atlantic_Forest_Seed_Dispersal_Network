...
### Analysis 1: biome-scale figure of frugivore degrees for higher and lower endangerment risk
...
```{r make the plot for analysis 1, warning=FALSE}
...
### Analysis 2 Data overview - looking at the degree data in the increasing and decreasing population groups
...
```{r analysis 2 get CIs for graphing, cache=TRUE}
...
```{r make the plot for analysis 2, warning=FALSE}
...
ggplot(aes(x = Frug_Population_Trend, y = Frugivore_degree, 
  ...
  scale_colour_manual(labels = c("Group mean", "Decreasing", "Increasing"), 
                      values = c("black","coral1", "deepskyblue3")) +
...
## Figures for both analysis 1 and 2 illustrating frugivore degrees in high vs low extinction risk groups and also in decreasing vs increasing population groups
...
ggplot(aes(x = ecoregion, y = Frugivore_degree, color = Frug_risk_level)) + 
  geom_point(size = 2, shape = 16, alpha = 0.7, # display data for each frug individually
             position=position_jitterdodge(jitter.width = 0.15)) + 
  geom_point(data = eco_means_risk, # use the temp df of means per ecoregion per category here
                  mapping = aes(x = ecoregion, y = mean, 
                                group = Frug_risk_level, color = "black"), 
             position = position_jitterdodge(jitter.width = 0.1), size = 1.4, shape = 17) + 
  ...
  scale_colour_manual(labels = c("Group mean", "Higher risk", "Lower risk"), 
                      values = c("black","darkred", "darkgoldenrod1")) +
...
ecoregion_deg.pop.plot <- ecoregion_pop_subset %>% ggplot(aes(x = ecoregion, 
                                                  y = Frugivore_degree, color = Frug_Population_Trend)) + 
  ...
  geom_point(data = eco_means_pops, # use the temp df of means per ecoregion per category here
                  mapping = aes(x = ecoregion, y = mean, 
                                group = Frug_Population_Trend, color = "black"), 
             position = position_jitterdodge(jitter.width = 0.1), size = 1.4, shape = 17) + 
...
save <- ggarrange(biome_deg.risk.level.plot, biome_deg.pop.trend.plot, ecoregion_deg.risk.plot, ecoregion_deg.pop.plot, legend_risk, legend_pop.trend, ncol = 2, nrow = 3, heights = c(8,8,1))

save # look at it

# save it 
#ggsave(save, file = "plots/degree_comparison_panel.pdf", units = "in", width = 6.75, height = 8, dpi = 400)

# save as png to put in manuscript
#ggsave(save, file = "plots/degree_comparison_panel.png", units = "in", width = 6.75, height = 8, dpi = 400)
...
### Table for analysis 4: proportions of specialist trees relying on endangered frugivores
...
```{r numbers of specialist trees and how many rely on endangered frugs}
...
# How many specialist trees are dispersed by only 1 frugivore in the biome?
...
biome_plants_1_noLC <- biome_plants_1 %>%
  filter(Frug_IUCN != "LC") 

# Store the counts

biome_plants_1 <- length(unique(biome_plants_1$Plant_Species))

biome_plants_1_noLC <- length(unique(biome_plants_1_noLC$Plant_Species))

######
## Plant degree = 2
#####

# How many specialist trees are dispersed by only 2 frugivore in the biome?
...
biome_plants_2_noLC <- biome_plants_2 %>%
  filter(Frug_IUCN != "LC") 

# Store the counts

biome_plants_2_noLC <- length(unique(biome_plants_2_noLC$Plant_Species))

biome_plants_2 <- length(unique(biome_plants_2$Plant_Species))

######
## Plant degree = 3
#####

# How many specialist trees are dispersed by only 3 frugivore in the biome?
...
biome_plants_3_noLC <- biome_plants_3 %>%
  filter(Frug_IUCN != "LC") 

# Store the counts

biome_plants_3_noLC <- length(unique(biome_plants_3_noLC$Plant_Species))

biome_plants_3 <- length(unique(biome_plants_3$Plant_Species))

######
## Plant degree = 4
#####

# How many specialist trees are dispersed by only 4 frugivore in the biome?
...
biome_plants_4_noLC <- biome_plants_4 %>%
  filter(Frug_IUCN != "LC") 

# Store the counts

biome_plants_4_noLC <- length(unique(biome_plants_4_noLC$Plant_Species))

biome_plants_4 <- length(unique(biome_plants_4$Plant_Species))

######
## Plant degree = 5
#####

# How many specialist trees are dispersed by only 5 frugivore in the biome?
...
biome_plants_5_noLC <- biome_plants_5 %>%
  filter(Frug_IUCN != "LC") 

# Store the counts

biome_plants_5_noLC <- length(unique(biome_plants_5_noLC$Plant_Species))

biome_plants_5 <- length(unique(biome_plants_5$Plant_Species))



#-----#----#-----#----#
# Repeat for Serra do Mar
#-----#----#-----#----#
...
serra.do.mar_plants_1_noLC <- serra.do.mar_plants_1 %>%
  filter(Frug_IUCN != "LC") 

# Store counts

serra.do.mar_plants_1_noLC <- length(unique(serra.do.mar_plants_1_noLC$Plant_Species))

serra.do.mar_plants_1 <- length(unique(serra.do.mar_plants_1$Plant_Species))

######
## Plant degree = 2
#####

# How many specialist trees are dispersed by only 2 frugivore in the Serra do Mar network?
...
serra.do.mar_plants_2_noLC <- serra.do.mar_plants_2 %>%
  filter(Frug_IUCN != "LC") 

# Store counts

serra.do.mar_plants_2_noLC <- length(unique(serra.do.mar_plants_2_noLC$Plant_Species))

serra.do.mar_plants_2 <- length(unique(serra.do.mar_plants_2$Plant_Species))

######
## Plant degree = 3
#####

# How many specialist trees are dispersed by only 3 frugivore in the Serra do Mar network?
...
serra.do.mar_plants_3_noLC <- serra.do.mar_plants_3 %>%
  filter(Frug_IUCN != "LC") 

# Store counts

serra.do.mar_plants_3_noLC <- length(unique(serra.do.mar_plants_3_noLC$Plant_Species))

serra.do.mar_plants_3 <- length(unique(serra.do.mar_plants_3$Plant_Species))
...
# How many specialist trees are dispersed by only 4 frugivore in the Serra do Mar network?
...
serra.do.mar_plants_4_noLC <- serra.do.mar_plants_4 %>%
  filter(Frug_IUCN != "LC") 

# Store counts

serra.do.mar_plants_4_noLC <- length(unique(serra.do.mar_plants_4_noLC$Plant_Species))

serra.do.mar_plants_4 <- length(unique(serra.do.mar_plants_4$Plant_Species))

######
## Plant degree = 5
#####

# How many specialist trees are dispersed by only 5 frugivore in the Serra do Mar network?
...
serra.do.mar_plants_5_noLC <- serra.do.mar_plants_5 %>%
  filter(Frug_IUCN != "LC") 

# Store counts

serra.do.mar_plants_5_noLC <- length(unique(serra.do.mar_plants_5_noLC$Plant_Species))

serra.do.mar_plants_5 <- length(unique(serra.do.mar_plants_5$Plant_Species))
...
# How many specialist trees are dispersed by only 1 frugivore in the cerrado?
...
cerrado_plants_1_noLC <- cerrado_plants_1 %>%
  filter(Frug_IUCN != "LC") 

# store the counts

cerrado_plants_1_noLC <- length(unique(cerrado_plants_1_noLC$Plant_Species))

cerrado_plants_1 <- length(unique(cerrado_plants_1$Plant_Species))

######
## Plant degree = 2
#####

# How many specialist trees are dispersed by only 2 frugivore in the cerrado?
...
cerrado_plants_2_noLC <- cerrado_plants_2 %>%
  filter(Frug_IUCN != "LC") 

# store the counts

cerrado_plants_2_noLC <- length(unique(cerrado_plants_2_noLC$Plant_Species))

cerrado_plants_2 <- length(unique(cerrado_plants_2$Plant_Species))

######
## Plant degree = 3
#####

# How many specialist trees are dispersed by only 3 frugivore in the cerrado?
...
cerrado_plants_3_noLC <- cerrado_plants_3 %>%
  filter(Frug_IUCN != "LC") 

# store the counts

cerrado_plants_3_noLC <- length(unique(cerrado_plants_3_noLC$Plant_Species))

cerrado_plants_3 <- length(unique(cerrado_plants_3$Plant_Species))

######
## Plant degree = 4
#####

# How many specialist trees are dispersed by only 4 frugivore in the cerrado?
...
cerrado_plants_4_noLC <- cerrado_plants_4 %>%
  filter(Frug_IUCN != "LC") 

# store the counts

cerrado_plants_4_noLC <- length(unique(cerrado_plants_4_noLC$Plant_Species))

cerrado_plants_4 <- length(unique(cerrado_plants_4$Plant_Species))

######
## Plant degree = 5
#####

# How many specialist trees are dispersed by only 5 frugivore in the cerrado?
...
cerrado_plants_5_noLC <- cerrado_plants_5 %>%
  filter(Frug_IUCN != "LC") 

# store the counts

cerrado_plants_5_noLC <- length(unique(cerrado_plants_5_noLC$Plant_Species))

cerrado_plants_5 <- length(unique(cerrado_plants_5$Plant_Species))



#-----#-----#-----#-----#-----#
# Repeat for mata caducifolia 
#-----#-----#-----#-----#-----#

# How many specialist trees are dispersed by only 1 frugivore in the mata.caducifolia?
...
mata.caducifolia_plants_1_noLC <- mata.caducifolia_plants_1 %>%
  filter(Frug_IUCN != "LC") 

# save the counts

mata.caducifolia_plants_1_noLC <- length(unique(mata.caducifolia_plants_1_noLC$Plant_Species))
mata.caducifolia_plants_1 <- length(unique(mata.caducifolia_plants_1$Plant_Species))

######
## Plant degree = 2
#####

# How many specialist trees are dispersed by only 2 frugivore in the mata.caducifolia?
...
mata.caducifolia_plants_2_noLC <- mata.caducifolia_plants_2 %>%
  filter(Frug_IUCN != "LC") 

# save the counts

mata.caducifolia_plants_2_noLC <- length(unique(mata.caducifolia_plants_2_noLC$Plant_Species))
mata.caducifolia_plants_2 <- length(unique(mata.caducifolia_plants_2$Plant_Species))

######
## Plant degree = 3
#####
# How many specialist trees are dispersed by only 3 frugivore in the mata.caducifolia?
...
mata.caducifolia_plants_3_noLC <- mata.caducifolia_plants_3 %>%
  filter(Frug_IUCN != "LC") 

# save the counts

mata.caducifolia_plants_3_noLC <- length(unique(mata.caducifolia_plants_3_noLC$Plant_Species))
mata.caducifolia_plants_3 <- length(unique(mata.caducifolia_plants_3$Plant_Species))

######
## Plant degree = 4
#####
# How many specialist trees are dispersed by only 4 frugivore in the mata.caducifolia?
...
mata.caducifolia_plants_4_noLC <- mata.caducifolia_plants_4 %>%
  filter(Frug_IUCN != "LC") 

# save the counts

mata.caducifolia_plants_4_noLC <- length(unique(mata.caducifolia_plants_4_noLC$Plant_Species))
mata.caducifolia_plants_4 <- length(unique(mata.caducifolia_plants_4$Plant_Species))

######
## Plant degree = 5
#####

# How many specialist trees are dispersed by only 5 frugivore in the mata.caducifolia?
...
mata.caducifolia_plants_5_noLC <- mata.caducifolia_plants_5 %>%
  filter(Frug_IUCN != "LC") 

# save the counts

mata.caducifolia_plants_5_noLC <- length(unique(mata.caducifolia_plants_5_noLC$Plant_Species))
mata.caducifolia_plants_5 <- length(unique(mata.caducifolia_plants_5$Plant_Species))
...
specialist_tree_table_biome <- data.frame(matrix(ncol = 5, nrow = 5))

# provide column names
colnames(specialist_tree_table_biome) <- c('Region', 'Plant_degree', 'Plant_species_total_count', 'Plant_species_only_dispersed_by_endangered_frugivores', 'Proportion_plant_spp_only_dispersed_by_endangered_frugivores') 

specialist_tree_table_biome$Region <- "Biome"

specialist_tree_table_biome$Plant_degree <-seq(1:5)

specialist_tree_table_biome$Plant_species_total_count <-c(biome_plants_1, biome_plants_2, biome_plants_3, biome_plants_4, biome_plants_5)

specialist_tree_table_biome$Plant_species_only_dispersed_by_endangered_frugivores <-c(biome_plants_1_noLC, biome_plants_2_noLC, biome_plants_3_noLC, biome_plants_4_noLC, biome_plants_5_noLC)

specialist_tree_table_biome$Proportion_plant_spp_only_dispersed_by_endangered_frugivores<-c(specialist_tree_table_biome$Plant_species_only_dispersed_by_endangered_frugivores/specialist_tree_table_biome$Plant_species_total_count)

####
# repeat per ecoregion
####

# serra do mar

# make blank data frame
specialist_tree_table_serra.do.mar <- data.frame(matrix(ncol = 5, nrow = 5))

# provide column names
colnames(specialist_tree_table_serra.do.mar) <- c('Region', 'Plant_degree', 'Plant_species_total_count', 'Plant_species_only_dispersed_by_endangered_frugivores', 'Proportion_plant_spp_only_dispersed_by_endangered_frugivores') 

specialist_tree_table_serra.do.mar$Region <- "serra.do.mar"

specialist_tree_table_serra.do.mar$Plant_degree <-seq(1:5)

specialist_tree_table_serra.do.mar$Plant_species_total_count <-c(serra.do.mar_plants_1, serra.do.mar_plants_2, serra.do.mar_plants_3, serra.do.mar_plants_4, serra.do.mar_plants_5)

specialist_tree_table_serra.do.mar$Plant_species_only_dispersed_by_endangered_frugivores <-c(serra.do.mar_plants_1_noLC, serra.do.mar_plants_2_noLC, serra.do.mar_plants_3_noLC, serra.do.mar_plants_4_noLC, serra.do.mar_plants_5_noLC)

specialist_tree_table_serra.do.mar$Proportion_plant_spp_only_dispersed_by_endangered_frugivores<-c(specialist_tree_table_serra.do.mar$Plant_species_only_dispersed_by_endangered_frugivores/specialist_tree_table_serra.do.mar$Plant_species_total_count)
...
# make blank data frame
specialist_tree_table_cerrado <- data.frame(matrix(ncol = 5, nrow = 5))

# provide column names
colnames(specialist_tree_table_cerrado) <- c('Region', 'Plant_degree', 'Plant_species_total_count', 'Plant_species_only_dispersed_by_endangered_frugivores', 'Proportion_plant_spp_only_dispersed_by_endangered_frugivores') 

specialist_tree_table_cerrado$Region <- "cerrado"

specialist_tree_table_cerrado$Plant_degree <-seq(1:5)

specialist_tree_table_cerrado$Plant_species_total_count <-c(cerrado_plants_1, cerrado_plants_2, cerrado_plants_3, cerrado_plants_4, cerrado_plants_5)

specialist_tree_table_cerrado$Plant_species_only_dispersed_by_endangered_frugivores <-c(cerrado_plants_1_noLC, cerrado_plants_2_noLC, cerrado_plants_3_noLC, cerrado_plants_4_noLC, cerrado_plants_5_noLC)

specialist_tree_table_cerrado$Proportion_plant_spp_only_dispersed_by_endangered_frugivores<-c(specialist_tree_table_cerrado$Plant_species_only_dispersed_by_endangered_frugivores/specialist_tree_table_cerrado$Plant_species_total_count)
...
# make blank data frame
specialist_tree_table_mata.caducifolia <- data.frame(matrix(ncol = 5, nrow = 5))

# provide column names
colnames(specialist_tree_table_mata.caducifolia) <- c('Region', 'Plant_degree', 'Plant_species_total_count', 'Plant_species_only_dispersed_by_endangered_frugivores', 'Proportion_plant_spp_only_dispersed_by_endangered_frugivores') 

specialist_tree_table_mata.caducifolia$Region <- "mata.caducifolia"

specialist_tree_table_mata.caducifolia$Plant_degree <-seq(1:5)

specialist_tree_table_mata.caducifolia$Plant_species_total_count <-c(mata.caducifolia_plants_1, mata.caducifolia_plants_2, mata.caducifolia_plants_3, mata.caducifolia_plants_4, mata.caducifolia_plants_5)

specialist_tree_table_mata.caducifolia$Plant_species_only_dispersed_by_endangered_frugivores <-c(mata.caducifolia_plants_1_noLC, mata.caducifolia_plants_2_noLC, mata.caducifolia_plants_3_noLC, mata.caducifolia_plants_4_noLC, mata.caducifolia_plants_5_noLC)

specialist_tree_table_mata.caducifolia$Proportion_plant_spp_only_dispersed_by_endangered_frugivores<-c(specialist_tree_table_mata.caducifolia$Plant_species_only_dispersed_by_endangered_frugivores/specialist_tree_table_mata.caducifolia$Plant_species_total_count)

###
#bring them together
###

specialist_tree_table <- rbind(specialist_tree_table_biome, specialist_tree_table_serra.do.mar, specialist_tree_table_cerrado, specialist_tree_table_mata.caducifolia)

###
# display
specialist_tree_table

```
Test. 
  This is displayed in 'Table 1' in the manuscript - you can see that large portions of the specialist trees at the biome and ecoregion scales tend to have a reliance on endangered frugivores as dispersal partners. NaNs are where there were no frugivores in that category.  

```{r neg binomial glm of specialist trees and higher risk frugivore associations}
# these models tend to work better when the data range includes 0, so subtract 1 from all in response variable
biome_interaction_md$Plant_degree_sub_one <- biome_interaction_md$Plant_degree-1 

specialist_tree_mod <- glm.nb(Plant_degree_sub_one ~ Frug_risk_level, data = biome_interaction_md)

# use glmmTBM to account for zero inflation - ziformula = ~1,

summary(specialist_tree_mod)

summary(specialist_tree_mod) # look at output

aov.specialist_tree_mod= Anova(specialist_tree_mod) # simplify model results

aov.specialist_tree_mod # display model results in simplified form

```

```{r model validation analysis 2}

sim.out.specialist_tree_mod <- simulateResiduals(fittedModel = specialist_tree_mod, plot = F)

plot(sim.out.specialist_tree_mod) # plot residual plots

testDispersion(sim.out.specialist_tree_mod, plot = T) # print dispersion results

testZeroInflation(sim.out.specialist_tree_mod, plot = T) # print zero-inflation results

```

  Not clear if data meets model assumptions.
