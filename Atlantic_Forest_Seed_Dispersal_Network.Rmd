...
out.aov.biome.deg.m2 = tidy(aov.biome.deg.m2) # get ready to save

# write.csv(out.aov.biome.deg.m2, file = "results/aov.biome.deg.poptrend.m2-results.csv") # save model output
