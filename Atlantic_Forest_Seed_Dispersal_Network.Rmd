...
rm(means, mean.int.95.BCa, i, biome_IUCN_lower_cis, biome_IUCN_upper_cis, biome_IUCN_means_boot, biome_plant_survivors_IUCN, temp_biome_IUCN)
```
...
rm(AR_plant_survivors_vec_IUCN_copy, AR_plant_survivors_IUCN_df, AR_plant_survivors_IUCN_mat, AR.robustness.ll,AR.survivors.ll, AR.new.mat, temp_AR_IUCN, AR.triggerlist.IUCN, AR_IUCN_s1, AR_plant_survivors_vec_IUCN)
```
...
rm(cerrado_plant_survivors_vec_IUCN_copy, cerrado_plant_survivors_IUCN_df, cerrado_plant_survivors_IUCN_mat, cerrado_robustness.ll,cerrado_survivors.ll, cerrado_new.mat, temp_cerrado_IUCN, cerrado_triggerlist.IUCN, cerrado_IUCN_s1, cerrado_plant_survivors_vec_IUCN)
```
...
```{r rbind the ecoregion coexinction data for graphing, eval=FALSE}
# PAUSING POINT - NOT DONE YET, PICK UP HERE WITH CLEANING
#ECOREGIONS:
